	   ...
	   templateObj.async(function(){
	       // to access a widget with an id of 'widget_id', use templateObj.$.widgetId 
        	...
        	templateObj.$.toggleTMP.addEventListener('changed',function(event){
                if (templateObj.$.toggleTMP.checked == true)
                    alert("Note: Due to the TMP007 device end-of-life, your BOOSTXL-SENSORS may not be populated with TMP007. Please visually inspect your board to see whether TMP007 is populated.");
