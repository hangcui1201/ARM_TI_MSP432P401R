...
Version 1.4.0: Added alert dialog to notify that TMP007 is no longer populated due to device end-of-life. If TMP007 is missuing, Enabling TMP007 will have no effect and will not return any valid temperature readings.