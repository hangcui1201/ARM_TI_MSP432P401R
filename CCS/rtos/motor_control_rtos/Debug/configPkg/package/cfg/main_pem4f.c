...
/* --> Clock_500ms */
extern xdc_Void Clock_500ms(xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Github_Sync/ARM_TI_MSP432P401R/CCS/rtos/motor_control_rtos/Debug/configPkg/package/cfg/main_pem4f");
...
ti_sysbios_knl_Clock_Object__ ti_sysbios_knl_Clock_Object__table__V[1] = {
    {/* instance#0 */
        ...
        1,  /* active */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)Clock_500ms)),  /* fxn */
        ((xdc_UArg)0),  /* arg */
    },
};
